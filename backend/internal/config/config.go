...
func setDefaults() {
	...
	viper.SetDefault("gateway.openai_ws.scheduler_score_weights.session_affinity", 0.6)
...
func (c *Config) Validate() error {
	...
	if c.Gateway.OpenAIWS.SchedulerScoreWeights.Priority < 0 ||
		...
		c.Gateway.OpenAIWS.SchedulerScoreWeights.SessionAffinity < 0 {
	...
	weightSum := c.Gateway.OpenAIWS.SchedulerScoreWeights.Priority +
		...
		c.Gateway.OpenAIWS.SchedulerScoreWeights.SessionAffinity
	if weightSum <= 0 {
